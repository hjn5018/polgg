...
- [x] **Dashboard**: 메인 페이지 Hacker News 스타일 텍스트 리스트 구현
- [x] **Search & Filter**: 포트폴리오 및 이력서 공개 여부에 따른 탐색 기능
...
- [x] 공개 포트폴리오 및 지원 데이터 수집 (RAG용)
- [x] Vector DB 연결 및 데이터 임베딩 로직 개발
- [x] LLM(GPT-4o 등) 연동 챗봇 API 구현
- [x] 챗봇 UI 컴포넌트 개발 및 통합 테스트
- [x] 시스템 성능 최적화 및 보안 점검
